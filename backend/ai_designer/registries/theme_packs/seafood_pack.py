...
THEMES = {
    "seafood_coastal": {
        ...
        "body":  {"font": FONT_BEBAS_NEUE, "color": (245, 235, 210), "size": 32, "marker": "✦",
                  "marker_color": (245, 235, 210), "letter_spacing": 2},
        "price": {"bg": (200, 60, 50), "fg": (245, 235, 210), "ring": (245, 235, 210), "font": FONT_SERIF_BOLD},
        "branding_color": (245, 235, 210),
        "icons": True,
