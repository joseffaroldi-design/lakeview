...
def _pil_background(theme_id: str, variant_idx: int) -> bytes:
    ...
    Chunk 7: extracted verbatim from routers/ai_designer.py. `THEME_STYLES`
    is imported lazily to avoid any module-load-order surprises (theme packs
    historically resolved late).
